...
class MyMainForm(QMainWindow, Ui_mainform.Ui_MainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.previewBtn.clicked.connect(lambda: self.AddTextWatermarkToImage(self.current_image_path))
...
if __name__ == "__main__":
    ...
    mywin = MyMainForm()
    mywin.show()
    mywin.current_image_path = 'test.jpg'
    # mywin.TestDisplayImage()
    # mywin.AddTextWatermarkToImage(mywin.current_image_path)
    sys.exit(app.exec_())
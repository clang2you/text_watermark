...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.autoColorCb = QtWidgets.QCheckBox(self.frame_2)
        self.autoColorCb.setObjectName("autoColorCb")
        self.horizontalLayout_2.addWidget(self.autoColorCb)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.autoColorCb.setText(_translate("MainWindow", "自动水印颜色"))
        self.menu.setTitle(_translate("MainWindow", "自动水印颜色转换设置"))
        self.actiondd.setText(_translate("MainWindow", "不同背景水印颜色设定"))
